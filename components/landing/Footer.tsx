  ...
  return (
    <footer className="border-t border-line bg-paper">
      ...
      <div className="border-t border-line">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-5 py-5 text-xs text-ink-soft sm:flex-row sm:items-center sm:justify-between md:px-8">
          <p>© {new Date().getFullYear()} Graan Studio. Todos los derechos reservados.</p>
          <p className="flex gap-5">
            <Link href="/login" className="hover:text-taupe-dark">
              Ingreso alumnas
            </Link>
